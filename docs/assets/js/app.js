	...
	var App = function (_Component) {
	  ...
	  (0, _createClass3.default)(App, [{
	    ...
	    value: function render(props, state) {
	      var _state$main = state.main,
	          projectTitle = _state$main.projectTitle,
	          version = _state$main.version;

	      return (0, _preact.h)(
	        "div",
	        { id: "app" },
	        (0, _preact.h)(Header, { title: projectTitle, version: version }),
	        (0, _preact.h)(MainContent, null)
	      );
	    }
	  }]);
	  return App;
