	...
	<section class="row-fluid-alt">
		<article class="span4">
			<div class="modal-parent" data-role="parent">
				...
				<span href="#" class="btn btn-secondary btn-small" data-role="trigger">Hover Trigger</span>
			</div>
		</article>
		<article class="span4">
			<div class="modal-parent" data-role="parent">
				...
				<span class="btn btn-secondary btn-small" data-role="trigger">hover over me</span>
			</div>
		</article>
		<article class="span4">
			<div class="modal-parent" data-role="parent">
